...
export const marketingCardTitle = "acq-headline text-[15px] font-semibold tracking-tight text-white sm:text-base";
...
export const marketingSectionY = "py-16 sm:py-20";

export const marketingShell = "mx-auto max-w-6xl";

export const marketingMeasureWide = "max-w-3xl";

export const sectionLabel = "text-[11px] font-semibold uppercase tracking-[0.2em] text-brand-300";
